...
.filters{position:sticky;top:calc(env(safe-area-inset-top,0px) + 50px);z-index:4;display:flex;flex-wrap:wrap;gap:6px;align-items:center;background:var(--bg);padding-block:8px;border-bottom:1px solid var(--line)}
